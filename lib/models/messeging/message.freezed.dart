...
mixin _$Message {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, messageId, receiverId,
      senderName, senderId, text, threadId, timestamp);

  @override
  String toString() {
    return 'Message(messageId: $messageId, receiverId: $receiverId, senderName: $senderName, senderId: $senderId, text: $text, threadId: $threadId, timestamp: $timestamp)';
  }
}
