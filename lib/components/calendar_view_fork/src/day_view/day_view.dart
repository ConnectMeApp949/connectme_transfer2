...
class DayViewState<T extends Object?> extends State<DayView<T>> {
  ...
  /// style markingStyle never set as far as I can tell
  /// style from day_view_componenents.dart -> DefaultTimeLineMark
// style: markingStyle ??
// TextStyle(
// fontSize: 15.0,
// ),
  Size measureTextSize(String text, TextStyle style) {
    ...
    )..layout(); // Layout to calculate size
  ...
  void _updateViewDimensions() {
    ...
    // final longestTimelabelSize = measureTextSize("10:45", TextStyle(fontSize: 15));
    // lg.t("_updateViewDimensions longestTimelabelSize 0 ~  " + longestTimelabelSize.toString());
    //
    // final longestTimelabelSize1 = measureTextSize("11:11", TextStyle(fontSize: 15));
    // lg.t("_updateViewDimensions longestTimelabelSize 1 ~  " + longestTimelabelSize1.toString());
    //
    // final longestTimelabelSize2 = measureTextSize("12 am", TextStyle(fontSize: 15));
    // lg.t("_updateViewDimensions longestTimelabelSize 2 ~  " + longestTimelabelSize2.toString());
    //
    // final longestTimelabelSize3 = measureTextSize("12 pm", TextStyle(fontSize: 15));
    // lg.t("_updateViewDimensions longestTimelabelSize 3 ~  " + longestTimelabelSize3.toString());
    //
    // final longestTimelabelSize4 = measureTextSize("10 am", TextStyle(fontSize: 15));
    // lg.t("_updateViewDimensions longestTimelabelSize 4 ~  " + longestTimelabelSize4.toString());

    // I/flutter ( 9081): 🔦️  _updateViewDimensions longestTimelabelSize 0 ~  Size(37.4, 18.0)
    // I/flutter ( 9081): 🔦️  _updateViewDimensions longestTimelabelSize 1 ~  Size(37.4, 18.0)
    // I/flutter ( 9081): 🔦️  _updateViewDimensions longestTimelabelSize 2 ~  Size(41.9, 18.0)
    // I/flutter ( 9081): 🔦️  _updateViewDimensions longestTimelabelSize 3 ~  Size(42.2, 18.0)
    // I/flutter ( 9081): 🔦️  _updateViewDimensions longestTimelabelSize 4 ~  Size(41.9, 18.0)

    /// pretty close with "12apm" instead of "12:pm"
    final longestTimelabelSize3 = measureTextSize("12apm", TextStyle(fontSize: 15));

    _timeLineWidth = widget.timeLineWidth ?? longestTimelabelSize3.width + 4;
  ...
  void _calculateHeights() {
    ...
    + ((widget.endMinute) * widget.heightPerMinute )
    - ((widget.startMinute) * widget.heightPerMinute ) + 88
    ;
  }
  ...
  void _assignBuilders() {
    ...
    _dayDetectorBuilder =
        widget.dayDetectorBuilder ?? _defaultPressDetectorBuilderWithMinutes;
  ...
  Widget _defaultPressDetectorBuilderWithMinutes({
    required DateTime date,
    required double height,
    required double width,
    required double heightPerMinute,
    ...
    required  double timeLineOffset,
      ...
      DefaultPressDetectorWithMinutes(
        date: date,
        height: height,
        width: width,
        heightPerMinute: heightPerMinute,
